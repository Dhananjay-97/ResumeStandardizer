...
def display_pdf(file, type="pdf"):
    ...
    poppler_path = "C:/Users/dhananjayl/Downloads/poppler-24.08.0/Library/bin"
    if type == 'image':
    ...
    try:
        ...
        try:
            result = subprocess.run(
                ["C:/Users/dhananjayl/AppData/Local/Programs/MiKTeX/miktex/bin/x64/pdflatex.exe", tex_file_path],
...
def get_default_download_folder():
    ...
    # downlaod_folder_path = os.path.join(str(Path.home()), "Desktop", "ResumeFlow", "templates")
